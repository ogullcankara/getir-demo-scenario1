...
public class automation {
    ...
    public static void main(String[] args) throws MalformedURLException {
        ...
        wait.until(ExpectedConditions.visibilityOfElementLocated(By.id("com.getir.casestudy.dev:id/tvTitle")));
        ...
        mobileElement = (MobileElement) ad.findElementByXPath("/hierarchy/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.view.ViewGroup/android.widget.FrameLayout[2]/android.widget.TextView");
        mobileElement.click();
